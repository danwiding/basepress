...
class NHP_Options{
	...
	*/
	function __construct($sections = array(), $args = array(), $extra_tabs = array()){
		...
		$this->options = (defined('NETWORK_OPTION') ? get_site_option($this->args['opt_name']) : get_option($this->args['opt_name']));
	...
	*/
	...
	function set($opt_name, $value) {
		...
		if (defined('NETWORK_OPTION'))
			update_site_option($this->args['opt_name'], $this->options);
		else
	...
	*/
	function _set_default_options(){
		if (defined('NETWORK_OPTION')):
			if(!get_site_option($this->args['opt_name'])){
				add_site_option($this->args['opt_name'], $this->_default_values());
			}
			$this->options = get_site_option($this->args['opt_name']);
		else:
	...
	*/
	function _download_options(){
		...
		$backup_options = (defined('NETWORK_OPTION') ? get_site_option($_GET['option']) : get_option($_GET['option']));
