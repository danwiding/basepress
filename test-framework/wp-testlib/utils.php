...
//	$testDbConnection = JuntoDatabaseAccessLayer::CreateConnection
//	(DB_HOST, DB_NAME, DB_USER, DB_PASSWORD, DB_CHARSET);
//
//	$testDbSchema = $testDbConnection->getSchemaManager()->createSchema();
//	$tables = $testDbSchema->getTables();
//	foreach ($tables as $table)
//		$testDbConnection->executeQuery("DROP TABLE IF EXISTS {$table->getName()}");
    global $wpdb;
